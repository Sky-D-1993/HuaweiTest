...
function one_node_test()
{
    ...
    sh -x   ./ipmi_function.sh  vnc_control  $2 $3  --ipaddr=$1
    sh -x   ./ipmi_function.sh  bios_update $2 $3  --ipaddr=$1
    sh -x   ./ipmi_function.sh  ibmc_update $2 $3  --ipaddr=$1
    ...
    sh -x   ./ipmi_function.sh  change_timezone  $2 $3  --ipaddr=$1 
    sh -x   ./ipmi_function.sh  delete_bmc_user  --ipaddr=$1 --username=usera
...
#all_node_test
one_node_test  10.128.205.74   Administrator Admin@9000
